...
import 'package:flutter_codigo_movies/drawer_widget.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text("Flutter Movies de Willy"),
          actions: [
            IconButton(
                            ...
                            child: Column(
                              children: [
                                ...
                                Row(
                                  children: [
                                    Icon(Icons.star),
                                    Text(moviesList[index]["popularity"]
                                        .toString()),
                                  ],
                                ),
                                Text(
  ...
  Future<Map> obtenerJson() async {
    String apiKey = "8862c0ec5b3d80e1b5f49b387a09bda6";
    var url = Uri.parse(
